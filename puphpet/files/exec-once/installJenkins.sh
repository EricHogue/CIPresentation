...
java -jar jenkins-cli.jar -s http://localhost:8080 install-plugin Git Phing GreenBalls ChuckNorris CloverPHP Crap4J Checkstyle JDepend PMD DRY HTMLPublisher Violations
